package com.ow0b.c7b9.app.old.chat;
...
import com.ow0b.c7b9.app.view.chat.sub.BarChartView;
import com.ow0b.c7b9.app.view.chat.sub.LineChartView;
import com.ow0b.c7b9.app.view.chat.sub.MidiChartView;
import com.ow0b.c7b9.app.view.chat.sub.ProgressGround;
...
{
    public HashSet<ProgressGround> backgrounds = new HashSet<>();
    ...
    {
        ApiClientImpl.getInstance(activity).url(activity.getResources().getString(R.string.server) + "api/library")
                .parameter("name", name)
                .get()
