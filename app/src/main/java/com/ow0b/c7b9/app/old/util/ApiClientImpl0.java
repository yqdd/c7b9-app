...
public class ApiClientImpl0
{
    private final static String TAG = ApiClientImpl0.class.getName();
    ...
    private ApiClientImpl0(Context context, int timeout)
    {
    ...
    {
        //检测服务器是否被关闭
        ApiClientImpl0.getInstance(activity, 2).url(activity.getResources().getString(R.string.server) + "/alive")
                .get()
    ...
    public ApiClientImpl0 url(String url)
    {
        this.url = url;
        return this;
    }
    public ApiClientImpl0 parameter(String key, String value)
    {
        parameters.put(key, value);
        return this;
    }
    public ApiClientImpl0 get()
    {
        return method("GET", new JsonObject());
    }
    public ApiClientImpl0 method(String method)
    {
        this.method = method;
        this.body = "";
        return this;
    }
    public ApiClientImpl0 method(String method, JsonElement body)
    {
        this.method = method;
    ...
    public ApiClientImpl0 method(String method, Object body)
    {
        this.method = method;
        this.type = "application/json";
    ...
    public ApiClientImpl0 method(String method, String body, String type)
    {
        this.method = method;
        this.type = type;
        this.body = body;
    ...
    public ApiClientImpl0 callback(Callback callback)
    {
    ...
    private static ApiClientImpl0 downloadResourceClient(Context context, ProgressBar progressBar, File saveFile, Runnable callback)
    {
        return ApiClientImpl0.getInstance(context).url(context.getResources().getString(R.string.server) + "/resource")
                .get()
                .callback(new Callback()
                {
                    @Override
